 ...
 * @author p1607831
 */
public class AddPionEffectTest {
    
    static Game aGame;
    
    public AddPionEffectTest() {
     ...
     */
    @Test
    public void testAddPionEffectNormalGame() {
        ...
        aGame.getBoard().getTileIJ(height - 3, 0).setEffect(new AddPionCurrentColorEffect());
        ...
        // - il y a bien dix pions de plus sur le plateau
        assertTrue("Doit être d'effet ajout pion", aGame.getBoard().getTileIJ(height - 3, 0).getEffect() instanceof AddPionCurrentColorEffect);
     ...
     * Résultats attendus : un pion de la couleur courante dans chaque colonne
     * est ajouté
     */
    @Test
    public void testAddPionCurrentColorEffectEmptyGame() {

        // Effet fixé sur une case 
        int height = aGame.getBoard().getHeight();
        aGame.getBoard().getTileIJ(height - 1, 0).setEffect(new AddPionCurrentColorEffect());
        ...
        assertTrue("Doit être d'effet ajout pion", aGame.getBoard().getTileIJ(height - 1, 0).getEffect() instanceof AddPionCurrentColorEffect);
        assertTrue(aGame.getCurrentPlayer().getId() != id_player);

    }

    /**
     * Test de AddPionCurrentColorEffect sur grille vide 
     ...
     * Résultat attendu : la case rempli de la couleur courante
    ...
    public void testChangeColorEffectFilledGame() {
        ...
        // Vérifications :
        // - la case est bien de la couleur du joueur courant apres
        // - l'effet est bien appliqué sur la case 
        // - le tour de jeu a bien changé
