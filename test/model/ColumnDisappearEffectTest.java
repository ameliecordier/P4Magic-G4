...
/**
 * Classe de test pour ColumnDisappear
 * @author Morgane Boussert - IUT Lyon 1
 */
public class ColumnDisappearEffectTest {
     ...
     */
    @Test
    public void ColumnDisappearEffectEmptyGame() {

        // Effet fixé sur une case 
        int height = aGame.getBoard().getHeight();
        aGame.getBoard().getTileIJ(height - 1, 0).setEffect(new ColumnDisappearEffect());
        ...
        assertTrue("Doit être d'effet ColumnDisappear", aGame.getBoard().getTileIJ(height - 1, 0).getEffect() instanceof ColumnDisappearEffect);
        assertTrue(aGame.getCurrentPlayer().getId() != id_player);
     ...
     */
    @Test
    public void testColumnDisappearEffecTwoTokensEmptyGame() {
        ...
        assertTrue("Doit être d'effet Column Disappear", aGame.getBoard().getTileIJ(height - 1, 0).getEffect() instanceof ColumnDisappearEffect);
        assertTrue("Doit être d'effet Column Disappear", aGame.getBoard().getTileIJ(height - 2, 0).getEffect() instanceof ColumnDisappearEffect);
        assertTrue(aGame.getCurrentPlayer().getId() == id_player);
     ...
     */
    @Test
    public void testColumnDisappearEffectEmptyGameWithTilesNumber() {
     ...
     * la colonne après application de l'effet 
     * Résultat attendu : la colonne doit être vide
     * et le tour doit être passé
     */
    @Test
    public void testColumnDisappearEffectFilledGame() {
        ...
        assertEquals(-1, aGame.getBoard().getTileIJ(height - 1, 0).getStatus());
        assertTrue("Doit être d'effet Column Disappear", aGame.getBoard().getTileIJ(height - 3, 0).getEffect() instanceof ColumnDisappearEffect);
