 ...
 * @author p1607831
 */
public class AppearPionEffectTest {
    static Game aGame;
    
    public AppearPionEffectTest() {
    }
     ...
     */
    @Test
    public void testAppearPionEffectNormalGame() {
        ...
        aGame.getBoard().getTileIJ(height - 3, 0).setEffect(new AppearPionEffect());
        ...
        assertTrue("Doit être d'effet appear pion random", aGame.getBoard().getTileIJ(height - 3, 0).getEffect() instanceof AppearPionEffect);
        assertTrue(aGame.getCurrentPlayer().getId() != id_player);
        assertEquals(nb_tokens_before + 1, nb_tokens_after);
    }

    /**
     * Test de AppearPionEffect sur grille vide 
     * Vérification de l'état de la tuile après application de l'effet 
     * Résultats attendus : la case doit être vide ou d'une couleur 
     * 
     */
    @Test
    public void testAppearPionEffectEmptyGame() {

        // Effet fixé sur une case 
        int height = aGame.getBoard().getHeight();
        aGame.getBoard().getTileIJ(height - 1, 0).setEffect(new AppearPionEffect());
        ...
        // - l'effet est bien appliqué sur la case 
        // - le tour de jeu a bien changé
        assertTrue("Doit être d'effet appear pion random", aGame.getBoard().getTileIJ(height - 1, 0).getEffect() instanceof AppearPionEffect);
        assertTrue(aGame.getCurrentPlayer().getId() != id_player);
     ...
     */
    @Test
    public void testAppearPionEffectEmptyGameWithTilesNumber() {
     ...
     */
    @Test
    public void testAppearPionEffectFilledGame() {
