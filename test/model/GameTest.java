...
/**
 * Classe de tests de la méthode win de la classe Game.
 * Le principe de la méthode : si 4 pions sont alignés (verticalement, horizon-
 * talement ou en diagonale), alors le joueur correspondant à la couleur gagne, 
 * la méthode retourne le joueur qui a gagné si un joueur a gagné.
 * Conséquences :
 * - le jeu est fini
 * 
 * 
