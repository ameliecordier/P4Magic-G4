...
public class DisappearColumnEffectTest {
     ...
     * la tuile après application de l'effet Résultats attendus : la case doit
     * être vide, le tour de jeu doit être passé
     */
    @Test
     ...
     * l'état de la tuile après application de l'effet Résultat attendu : les
     * cases en-dessous doivent être vides, l'effet doit être sur la case et le
